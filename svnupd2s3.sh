...
# Usage:
#      Prior to 1st use only, prepare the svn workspace using ./svnco2s3.sh <svnrepourl> <svnworkspace>
#      Update the variables within the script or set prior to calling this script
#      ./svnupd2s3.sh 
#
...
export SCRIPT_HOME=/opt/svnupd2s3
export SVN_WORKSPACE=/opt/svnupd2s3/workspace
...
cd $SVN_WORKSPACE
svn update > $SCRIPT_HOME/svnupdate.log
